...
{{< landing/hero
    ...
    subtitle="6. 7. – 24. 7. 2026, FMFI UK, Bratislava" >}}
...
Letná škola Trojstenu je 3-týždňová letná škola organizovaná vedúcimi - dobrovoľníkmi korešpondenčných seminárov z matematiky, fyziky a programovania, patriacich pod o. z. Trojsten, v spolupráci s FMFI UK.
...
Letná škola prebieha v týždňoch od 6. 7. do 24. 7. 2026, nemusíš sa však zúčastniť celej Letnej školy. Môžeš si vybrať tú časť, ktorá ťa zaujíma a vyhovuje ti:
...
{{< grid/grid >}}
    ...
    >}}
       Môžeš sa naučiť základy programovacieho jazyka, jednoduché aj pokročilejšie algoritmy a dátové štruktúry
    ...
    {{</ grid/image >}}
    {{< grid/image
        title="Letná škola matematiky: 13. 7. - 24. 7."
    ...
    {{</ grid/image >}}
    {{< grid/image
        title="Letná škola fyziky: 13. 7. - 24. 7."
        image="aktivity/fks-1.jpg"
        href="https://fks.sk/ls/"
    >}}
       Prvý týždeň bude tvorený najmä matematickými a programovacími prednáškami užitočnými pre fyziku.
       V druhom týždni pokryjeme témy od síl a zrýchlení, cez základy jadrovej fyziky a špeciálnu relativitu až po termodynamiku plynov,
...
>}}
    {{< landing/icon-list >}}
        ...
        {{< landing/icon-list-item icon=""
            title="13:30 – 16:00 → Praktické zručnosti, programovanie, workshopy…"
            text="Táto časť bude spoločná pre programátorov, matematikov aj fyzikov. Budete si môcť zmerať sily v súťaži Náboj, či doplniť praktické skúsenosti so spracovaním dát alebo tvorbou modernej webstránky." >}}
        {{< landing/icon-list-item icon=""
            title="16:30 - 22:00 → Voľnočasový program"
...
Hneď ako vyplníš prihlášku, môžeš s Letnou školou počítať. Ďalšia potrebná komunikácia prebehne mailom tesne pred začiatkom. Ak ešte nemáš 18 rokov, tvoj zákonný zástupca alebo rodič musí vyplniť informovaný súhlas o účasti na Letnej škole (dostaneš mailom pred začiatkom), ktorý nám odovzdáš pri príchode. Tým berie na vedomie, že sa Letnej školy Trojstenu zúčastňuješ na vlastnú resp. jeho zodpovednosť.

Z povahy letnej školy, keďže nejde o sústredenie v samostatnom objekte, nemôžeme zabezpečiť neustály dohľad nad každým účastníkom. Veríme, že účastníci sú dostatočne zodpovední, aby zvládli účasť na Letnej škole aj s takouto podmienkou.

## Do kedy sa môžem prihlásiť?

Termín na prihlásenie je do 21.6., (orientačne druhá polovica júna). Ak sa chceš prihlásiť po tomto dátume, napíš nám na [letna.skola@trojsten.sk](mailto:letna.skola@trojsten.sk).
...
Maj na pamäti, že prednášky môžu na seba nadväzovať. Takže Ti odporúčame účasť na čo najsúvislejšej a najdlhšej časti. Taktiež, v prípade zaplnenia kapacity budeme v každom týždni preferovať tých účastníkov, ktorí sa zúčastnia celého týždňa.
